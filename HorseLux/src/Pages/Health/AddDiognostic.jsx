...
import { InjuryData, addDiognostic, vitalsRecord } from "../../config/Horses";
            ...
            <div className="w-full">
             ...
             <Popover
              ...
              <div className=" justify-between   w-[45%] ">
                ...
                <div className=" justify-between   w-[45%] -mt-20  "></div>
                <button
                  type="submit"
                  onClick={toHome}
